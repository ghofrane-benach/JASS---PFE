...
export const seedCategories = async (dataSource: DataSource) => {
  ...
  const products = [
    ...
    // ════════════════════════════════════════
    {
      ...
      subcategory: null,
      images: ['/images/scarfs/pink.jpeg', 
    ...
    },
    {
      ...
      subcategory: null,
      images: ['/images/scarfs/bleu ciel.jpeg', 
    ...
    },
    {
      ...
      {
      name: 'Collier serpent ',
      price: 25, stock: 18,
      description: 'Collier à double chaîne en or pour femmes, chaîne de serpent brillante en acier inoxydable.',
      subcategory: 'colliers',
      images: ['/images/accessoires/collierfin.png',
         '/images/accessoires/collierfin1.jpng', '/images/accessoires/collierfin2.png'],
      category: A,
    },
    {
    ...
    },
{
    ...
    {
      name: 'Serie 3 Bagues dorée',              
      price: 10, stock: 22,
      description: 'Trois Bagues en acier inoxydable.',
      subcategory: 'bagues',
      images: [
        '/images/accessoires/3bagues.png',
        '/images/accessoires/3bagues1.png',
        '/images/accessoires/3bagues2.png',
         ],
      category: A,
    },
    // ════════════════════════════════════════
    ...
    },
    {
      ...
      price: 100, stock: 22,
      description: 'Lapel collar blazer. Double-breasted front fastening. Side flap pockets. Interior lining. Loose fit.',
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/burgundy.png', 
        '/images/clothing/burgundy1.png'],
      category: C,
    },
    {
      name: ' Blazer Noir',                
      ...
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/blazernoir.png', 
        '/images/clothing/blazernoir1.png',
      '/images/clothing/blazernoir2.png'],
      category: C,
    },
    {
      name: 'Short faux suede trench coat',      
      price: 150, stock: 22,
      description: 'Short long sleeve trench coat with a lapel collar and a double-breasted button fastening. Featuring two side pockets.',
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/trench.png', 
        '/images/clothing/trench1.png',
      '/images/clothing/trench2.png'],
      category: C,
    },
     {
      name: 'Burgundy Blazer Chic',      
      price: 150, stock: 22,
      description: 'Blazer short, chic en burgundy pour femme.',
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/burgundy.png', 
        '/images/clothing/burgundy1.png',
      '/images/clothing/burgundy2.png'],
      category: C,
    },
    {
      name: 'Veste Mirosa',      
      price: 150, stock: 22,
      description: 'Veste courte, sport chic pour femme.',
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/vestemarron.png', 
        '/images/clothing/vestemarron1.png',
      '/images/clothing/vestemarron2.png',
      '/images/clothing/vestemarron11.png'],
      category: C,
    },
     {
      name: 'Veste Blazer ',      
      price: 150, stock: 22,
      description: 'Veste Blazer,chic pour femme en Burgundy.',
      subcategory: 'vestes',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/vesteblazer.png', 
        '/images/clothing/vesteblazer1.png',
      '/images/clothing/vesteblazer2.png',
    ],
      category: C,
    },

    {
      ...
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemiserayé.png', 
        '/images/clothing/chemiserayé1.png'],
      category: C,
    },
    {
      name: 'Chemise décontractée avec manches évasées décorées',              
      price: 45, stock: 22,
      description: 'Chemise décontractée pour femmes avec manches évasées décorées de boutons, blouse en polyester de couleur unie, printemps.',
      subcategory: 'Chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemisevert.png', 
        '/images/clothing/chemisevert1.png',
        '/images/clothing/chemisevert2.png'],
      category: C,
    },
    {
      name: 'Chemise à manches longues',              
      price: 45, stock: 22,
      description: 'Chemise à manches longues avec boutons devant et poche, rayures rouges et blanches, automne printemps.',
      subcategory: 'Chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemiserouge.png', 
        '/images/clothing/chemiserouge1.png',
        '/images/clothing/chemiserouge2.png'],
      category: C,
    },
    {
      name: 'Chemise à l encre noir et blanc',              
      price: 45, stock: 22,
      description: 'Chemise élégante et décontractée à manches longues avec motif de peinture à lencre noir et blanc.',
      subcategory: 'Chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemise.png', 
        '/images/clothing/chemise1.png',
       '/images/clothing/chemise2.png'],
      category: C,
    },
    {
      name: 'Chemise Blanche ',              
      price: 45, stock: 22,
      description: 'Chemise Blanche Courte .',
      subcategory: 'Chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemiseblanche.jpeg',
         '/images/clothing/chemiseblanche1.jpeg'],
      category: C,
    },
    {
      name: ' Set Denim & Denim',              
      price: 115, stock: 22,
      description: 'Set en denim foncée.',
      subcategory: 'sets',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/denim.jpeg', '/images/clothing/denim1.jpeg'],
      category: C,
    },
    {
      name: ' Set Chic Gris ',              
      price: 115, stock: 22,
      description: 'EURMUSE Ensemble blazer et pantalon décontracté à coupe ample pour jeunes femmes à double boutonnage.',
      subcategory: 'sets',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/setgris.png', 
        '/images/clothing/setgris1.png',
      '/images/clothing/setgris2.png'],
      category: C,
    },
    {
      name: ' Set Chic Bleu rayé ',              
      price: 115, stock: 22,
      description: 'EURMUSE Ensemble blazer et pantalon décontracté à coupe ample pour jeunes femmes à double boutonnage.',
      subcategory: 'sets',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/setbleu.png', 
        '/images/clothing/setbleu1.png',
      '/images/clothing/setbleu2.png'],
      category: C,
    },
    {
      name: ' Set Chic Bourdeaux rayé ',              
      price: 115, stock: 22,
      description: 'Aloruh Ensemble tailleur élégant pour femme, veste et pantalon.',
      subcategory: 'sets',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/setburgundy.png', 
        '/images/clothing/setburgundy1.png',
      '/images/clothing/setburgundy2.png'],
      category: C,
    },
    {
      name: ' Chemise Jaune ample décontracté à manches évasées',              
      price: 45, stock: 22,
      description: 'Chemise jaune ample décontracté à manches évasées et nœud devant pour femmes, couleur unie.',
      subcategory: 'chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemisejaune.png', 
        '/images/clothing/chemisejaune1.png',
      '/images/clothing/chemisejaune2.png'],
      category: C,
    },
    {
      name: ' Chemise Rose Basic',              
      price: 45, stock: 22,
      description: 'Chemise décontractée mode polyvalente pour femmes, style minimaliste/casual chic.',
      subcategory: 'chemises',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/chemiserose.png', 
        '/images/clothing/chemiserose1.png',
      '/images/clothing/chemiserose2.png'],
      category: C,
    },
    {
      name: ' Radiana Pantalon large oversize',              
      price: 65, stock: 22,
      description: 'Radiana Pantalon large oversize mode minimaliste café foncé pour femmes.',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/radiana.png', 
        '/images/clothing/radiana1.png',
      '/images/clothing/radiana2.png'],
      category: C,
    },
    {
      name: ' Baggy wide-leg jeans',              
      price: 100, stock: 22,
      description: 'Long five-pocket jeans with a metal zip and button fastening at the front. Mid-waist with wide-legs. Made from 100% cotton denim fabric..',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/baggy1.png', 
        '/images/clothing/baggy.png',
      '/images/clothing/baggy2.png'],
      category: C,
    },
    {
      name: ' Straight jeans',              
      price: 95, stock: 22,
      description: 'Long five-pocket jeans with a metal zip fly and button fastening. Straight-leg and mid-waist. Made of stretch cotton denim fabric',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/straight.png', 
        '/images/clothing/straight1.png',
      '/images/clothing/straight2.png'],
      category: C,
    },
     {
      name: ' Dazy jeans',              
      price: 95, stock: 22,
      description: 'DAZY Jeans droits taille haute ample amincissants, minimaliste et polyvalent, pantalon confortable à longueur cheville pour femmes',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/dazyjeans.png', 
        '/images/clothing/dazyjeans1.png',
      '/images/clothing/dazyjeans2.png'],
      category: C,
    },
     {
      name: ' Pantalon à jambes larges',              
      price: 95, stock: 22,
      description: 'Flirla Pantalon à jambes larges pour femmes avec lien à la taille et poches, de couleur unie',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/pantalonrose.png', 
        '/images/clothing/pantalonrose1.png',
      '/images/clothing/pantalonrose2.png'],
      category: C,
    },
     {
      name: ' Pantalon droit ample à taille élastique',              
      price: 95, stock: 22,
      description: ' Unity Pantalon droit ample à taille élastique, couleur unie, avec cordon de serrage et poches, pour femmes',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/pantalonvert.png', 
        '/images/clothing/pantalonvert1.png',
      '/images/clothing/pantalonvert2.png'],
      category: C,
    },
    {
      name: ' Pantalon Radiana',              
      price: 95, stock: 22,
      description: ' Unity Pantalon droit ample à taille élastique, couleur unie, avec cordon de serrage et poches, pour femmes',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
    ...
    {
      name: ' Blue indiago Jeans',              
      price: 95, stock: 22,
      description: ' Denim jeans, High-waist. Wide leg',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/bleuindiago.png', 
        '/images/clothing/bleuindiago1.png',
      '/images/clothing/bleuindiago2.png'],
      category: C,
    },
    
    
     {
      name: 'Slim fit wide jeans',              
      price: 95, stock: 22,
      description: 'Denim jeans. High-waist. Straight leg. Button and metal zip fastening. 100% cotton denim fabric.',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/slim.png', 
        '/images/clothing/slim1.png',
      '/images/clothing/slim2.png',
    '/images/clothing/slim3.png'],
      category: C,
    },
     {
      name: ' Basic wide-leg trousers',              
      price: 90, stock: 22,
      description: 'High-waist trousers with belt loops. Zip and metal hook fastening. Side pockets.',
      subcategory: 'pantalons',
      sizes: ['S', 'M', 'L', 'XL', 'XXL'] ,
      images: ['/images/clothing/basicbeige.png', 
        '/images/clothing/basicbeige1.png',
      '/images/clothing/basicbeige2.png'],
      category: C,
    },
  ];
  ...
  for (const p of products) {
    ...
    if (existing) {
      ...
      const { subcategory, sizes, ...productData } = p;
