...
export default function ProductDetailPage() {
  ...
  const btnLabel = { idle: 'Ajouter au panier', loading: 'Ajout en cours…', success: '✓ Ajouté au panier !', error: 'Erreur — Réessayer' }[cartStatus];
...
function RelatedCard({ product }: { product: Product }) {
  ...
  return (
    <Link href={`/product/${product.id}`} style={styles.relatedCard}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // Carousel section — thumbnails à gauche + image principale
